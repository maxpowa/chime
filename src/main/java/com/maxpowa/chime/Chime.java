...
public class Chime {
    ...
    public void RenderTickEvent(RenderTickEvent event) {
        ...
        if (event.type == Type.RENDER && event.phase == Phase.END && mc.currentScreen != null && !(mc.currentScreen instanceof IChimeGUI) && Initializer.initialized) {
    ...
    public void onClientTick(ClientTickEvent event) {
        ...
        // If this somehow fails to update the server for 30 seconds, you may
    ...
    private void authenticateClient() {
        ...
        if (Chime.myProfile.getId() == null) {
            ...
            if (matchingProfiles.length > 0) {
                String uuid = matchingProfiles[0].getId().replaceAll("(\\w{8})(\\w{4})(\\w{4})(\\w{4})(\\w{12})", "$1-$2-$3-$4-$5");
