...
public class Initializer implements ValueEventListener {
    ...
    public void onDataChange(DataSnapshot data) {
        ...
        if (!Chime.myUser.getConfig().isInvisible()) {
            ...
            Chime.me.child("lastSeen").setValue(System.currentTimeMillis()); // Should
                                                                             // make
                                                                             // me
                                                                             // appear
                                                                             // online
        ...
        Chime.public_requests.child(data.getRef().getPath() + "/requests").addChildEventListener(new FriendRequestListener(Chime.myProfile.getId().toString()));
